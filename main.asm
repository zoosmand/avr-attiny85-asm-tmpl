...
MAIN:
  ...
  SCHEDULER SecCnt, 4, LedBlueStack, _LUP_, _END_SCHED_01
  _END_SCHED_01:
    nop

  SCHEDULER SecCnt, 5, LedGreenStack, _LUP_, _END_SCHED_02
  _END_SCHED_02:
    nop

  SCHEDULER SecCnt, 3, LedRedStack, _LUP_, _END_SCHED_03
  _END_SCHED_03:
    nop
